...
public class Cargar_Usuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(res.next()){
                u.setId(res.getInt("con_id"));
                u.setNombre(res.getString("con_nombre"));
                u.setTelefono(res.getString("con_telefono"));
                u.setEmail(res.getString("con_email"));
            ...
            if(opc.equals("delete")){
                conDB.borrarUsuario(u);
                response.sendRedirect("ImprimirBD");
            }
        }catch(Exception e){
